    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                ...
                LOGGER(__name__).error(
                    "Assistant 1 failed to access log group. Make sure it's added as admin!"
                )
                exit()
        ...
        if config.STRING2:
            ...
            try:
                ...
                LOGGER(__name__).error(
                    "Assistant 2 failed to access log group. Make sure it's added as admin!"
                )
                exit()
        ...
        if config.STRING3:
            ...
            try:
                ...
                LOGGER(__name__).error(
                    "Assistant 3 failed to access log group. Make sure it's added as admin!"
                )
                exit()
        ...
        if config.STRING4:
            ...
            try:
                ...
                LOGGER(__name__).error(
                    "Assistant 4 failed to access log group. Make sure it's added as admin!"
                )
                exit()
        ...
        if config.STRING5:
            ...
            try:
                ...
                LOGGER(__name__).error(
                    "Assistant 5 failed to access log group. Make sure it's added as admin!"
                )
                exit()
